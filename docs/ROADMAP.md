...
- [ ] **2.6** [Q] **Deterministic e2e: no test anyone learns to re-run.** Two known flakes, one task, because the goal is the same — a red run has to mean something, and the moment a second test is "just re-run it", people stop reading CI at all. Do both before the phase-2 review.
