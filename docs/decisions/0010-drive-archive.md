...
- **Retention:** local copies are deleted after 90 days (photos) or 30 days (video), and only once the Drive copy is confirmed. The Drive archive and all metadata are permanent.
