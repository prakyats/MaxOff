 ...
 * Owner has no attendance of their own, and an unknown id is a 404, not an empty page. Cached
 * per request: the layout's header and the page both ask.
 */
export const loadPerson = cache(async (id: string): Promise<TeamMember> => {
