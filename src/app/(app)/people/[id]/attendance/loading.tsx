...
/**
 * A person's month (2.4) under the layout's header and tabs: the month switcher row, then cards
 * on a phone and the table from `md` up, as on the member's own /leave/attendance.
 */
